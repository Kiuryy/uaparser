...
func _() {
	...
	_ = x[BrowserOpera-8]
	_ = x[BrowserBrave-9]
	_ = x[BrowserBlackberry-10]
	_ = x[BrowserUCBrowser-11]
	_ = x[BrowserSilk-12]
	_ = x[BrowserQQ-13]
	_ = x[BrowserSpotify-14]
	_ = x[BrowserNintendo-15]
...
const _BrowserName_name = ""

var _BrowserName_index = [...]uint16{0, 14, 27, 42, 51, 62, 75, 89, 103, 115, 127, 144, 160, 171, 180, 194, 209, 223, 236, 249, 259, 274, 289, 303, 323, 341, 357, 375, 388, 405, 422, 438, 454, 469}
