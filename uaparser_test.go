...
var testUAVars = []struct {
	...
	{"Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Ubuntu Chromium/69.0.3497.81 Chrome/69.0.3497.81 Safari/537.36",
		useragent.UserAgent{
			useragent.Browser{vars.BrowserChromium, version.Version{69, 0, 3497}},
	...
	{"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Ubuntu Chromium/75.0.3731.0 Chrome/75.0.3731.0 Safari/537.36",
		useragent.UserAgent{
			useragent.Browser{vars.BrowserChromium, version.Version{75, 0, 3731}},
	...
	{"Mozilla/5.0 (Macintosh; Intel Mac OS X 10_10_4) AppleWebKit/600.7.12 (KHTML, like Gecko) Version/8.0.7 Safari/600.7.12",
		useragent.UserAgent{
			useragent.Browser{vars.BrowserSafari, version.Version{8, 0, 7}},
			useragent.OS{vars.PlatformMac, vars.OSMacOS, version.Version{10, 10, 4}, "Yosemite"},
			vars.DeviceComputer,
		},
	},
	...
	{"Mozilla/5.0 (Macintosh; Intel Mac OS X 10_12) AppleWebKit/602.1.32 (KHTML, like Gecko) Version/10.0 Safari/602.1.32", // macOS Sierra dev beta
		useragent.UserAgent{
			useragent.Browser{vars.BrowserSafari, version.Version{10, 0, 0}},
			useragent.OS{vars.PlatformMac, vars.OSMacOS, version.Version{10, 12, 0}, "Sierra"},
			vars.DeviceComputer,
		},
	},
	{"Mozilla/5.0 (Macintosh; Intel Mac OS X 10_14) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/12.0 Safari/605.1.15",
		useragent.UserAgent{
			useragent.Browser{vars.BrowserSafari, version.Version{12, 0, 0}},
			useragent.OS{vars.PlatformMac, vars.OSMacOS, version.Version{10, 14, 0}, "Mojave"},
			vars.DeviceComputer,
		},
	},
	{"Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_1) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/12.0.2 Safari/605.1.15",
		useragent.UserAgent{
			useragent.Browser{vars.BrowserSafari, version.Version{12, 0, 2}},
			useragent.OS{vars.PlatformMac, vars.OSMacOS, version.Version{10, 15, 1}, "Catalina"},
			vars.DeviceComputer,
		},
	},
	...
	{"Mozilla/5.0 (compatible; MSIE 10.0; Windows NT 6.2; Trident/6.0)",
		useragent.UserAgent{
			useragent.Browser{vars.BrowserIE, version.Version{10, 0, 0}},
			useragent.OS{vars.PlatformWindows, vars.OSWindows, version.Version{6, 2, 0}, "8"},
			vars.DeviceComputer,
		},
	},
	{"Mozilla/5.0 (Windows NT 6.3; Trident/7.0; .NET4.0E; .NET4.0C; rv:11.0) like Gecko",
		useragent.UserAgent{
			useragent.Browser{vars.BrowserIE, version.Version{11, 0, 0}},
			useragent.OS{vars.PlatformWindows, vars.OSWindows, version.Version{6, 3, 0}, "8.1"},
			vars.DeviceComputer,
		},
	},
	{"Mozilla/4.0 (compatible; MSIE 5.01; Windows NT 5.0; SV1; .NET CLR 1.1.4322; .NET CLR 1.0.3705; .NET CLR 2.0.50727)",
		useragent.UserAgent{
			useragent.Browser{vars.BrowserIE, version.Version{5, 0, 1}},
			useragent.OS{vars.PlatformWindows, vars.OSWindows, version.Version{5, 0, 0}, "2000"},
			vars.DeviceComputer,
		},
	},
	{"Mozilla/4.0 (compatible; MSIE 7.0; Windows NT 6.1; WOW64; Trident/4.0; GTB6.4; SLCC2; .NET CLR 2.0.50727; .NET CLR 3.5.30729; .NET CLR 3.0.30729; Media Center PC 6.0; OfficeLiveConnector.1.3; OfficeLivePatch.0.0; .NET CLR 1.1.4322)",
		useragent.UserAgent{
			useragent.Browser{vars.BrowserIE, version.Version{7, 0, 0}},
			useragent.OS{vars.PlatformWindows, vars.OSWindows, version.Version{6, 1, 0}, "7"},
			vars.DeviceComputer,
		},
	},
	...
	{"mozilla/5.0 (ipod touch; cpu iphone os 9_3_3 like mac os x) applewebkit/601.1.46 (khtml, like gecko) version/9.0 mobile/13g34 safari/601.1",
		useragent.UserAgent{
			useragent.Browser{vars.BrowserSafari, version.Version{9, 0, 0}},
			useragent.OS{vars.PlatformiPod, vars.OSiOS, version.Version{9, 3, 3}, ""},
			vars.DeviceTablet,
		},
	},
	{"mozilla/5.0 (ipod; cpu iphone os 6_1_6 like mac os x) applewebkit/536.26 (khtml, like gecko) version/6.0 mobile/10b500 safari/8536.25",
		useragent.UserAgent{
			useragent.Browser{vars.BrowserSafari, version.Version{6, 0, 0}},
			useragent.OS{vars.PlatformiPod, vars.OSiOS, version.Version{6, 1, 6}, ""},
			vars.DeviceTablet,
		},
	},
	...
	{"mozilla/5.0 (smart-tv; linux; tizen 2.3) applewebkit/538.1 (khtml, like gecko) samsungbrowser/1.0 tv safari/538.1", // Samsung SmartTV
		useragent.UserAgent{
			useragent.Browser{vars.BrowserSamsung, version.Version{0, 0, 0}},
			useragent.OS{vars.PlatformLinux, vars.OSLinux, version.Version{0, 0, 0}, ""},
			vars.DeviceTV,
		},
	},
	...
	{"Mozilla/5.0 (Windows NT 6.2; WOW64; Trident/7.0; Touch; .NET4.0E; .NET4.0C; .NET CLR 3.5.30729; .NET CLR 2.0.50727; .NET CLR 3.0.30729; InfoPath.3; Tablet PC 2.0; QQBrowser/7.6.21433.400; rv:11.0) like Gecko",
		useragent.UserAgent{
			useragent.Browser{vars.BrowserQQ, version.Version{7, 6, 21433}},
			useragent.OS{vars.PlatformWindows, vars.OSWindows, version.Version{6, 2, 0}, "8"},
			vars.DeviceTablet,
		},
	},
	{"Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/43.0.2357.124 Safari/537.36 QQBrowser/9.0.2191.400",
		useragent.UserAgent{
			useragent.Browser{vars.BrowserQQ, version.Version{9, 0, 2191}},
			useragent.OS{vars.PlatformWindows, vars.OSWindows, version.Version{6, 1, 0}, "7"},
			vars.DeviceComputer,
		},
	},
	{"mozilla/5.0 (iphone; cpu iphone os 8_1_2 like mac os x) applewebkit/600.1.4 (khtml, like gecko) mobile/12b440 qq/5.3.0.319 nettype/wifi mem/205",
		useragent.UserAgent{
			useragent.Browser{vars.BrowserQQ, version.Version{5, 3, 0}},
			useragent.OS{vars.PlatformiPhone, vars.OSiOS, version.Version{8, 1, 2}, ""},
			vars.DevicePhone,
		},
	},
	...
	{"Mozilla/5.0 (Windows; U; Windows NT 6.1; sk; rv:1.9.1.7) Gecko/20091221 Firefox/3.5.7",
		useragent.UserAgent{
			useragent.Browser{vars.BrowserFirefox, version.Version{3, 5, 7}},
			useragent.OS{vars.PlatformWindows, vars.OSWindows, version.Version{6, 1, 0}, "7"},
			vars.DeviceComputer,
		},
	},
	...
	{"Mozilla/5.0 (Windows NT 6.2; WOW64) AppleWebKit/536.5 (KHTML, like Gecko) YaBrowser/1.0.1084.5402 Chrome/19.0.1084.5402 Safari/536.5",
		useragent.UserAgent{
			useragent.Browser{vars.BrowserYandex, version.Version{1, 0, 1084}},
			useragent.OS{vars.PlatformWindows, vars.OSWindows, version.Version{6, 2, 0}, "8"},
			vars.DeviceComputer,
		},
	},
	{"Mozilla/5.0 (Windows NT 6.2; WOW64) AppleWebKit/537.15 (KHTML, like Gecko) Chrome/24.0.1295.0 Safari/537.15",
		useragent.UserAgent{
			useragent.Browser{vars.BrowserChrome, version.Version{24, 0, 1295}},
			useragent.OS{vars.PlatformWindows, vars.OSWindows, version.Version{6, 2, 0}, "8"},
			vars.DeviceComputer,
		},
	},
	...
	{"Mozilla/4.0 (compatible; MSIE 8.0; Windows NT 6.0; Trident/4.0; SLCC1; .NET CLR 2.0.50727; .NET CLR 1.1.4322; InfoPath.2; .NET CLR 3.5.21022; .NET CLR 3.5.30729; MS-RTC LM 8; OfficeLiveConnector.1.4; OfficeLivePatch.1.3; .NET CLR 3.0.30729)",
		useragent.UserAgent{
			useragent.Browser{vars.BrowserIE, version.Version{8, 0, 0}},
			useragent.OS{vars.PlatformWindows, vars.OSWindows, version.Version{6, 0, 0}, "Vista"},
			vars.DeviceComputer,
		},
	},
	{"Mozilla/5.0 (Windows; U; Windows NT 5.1; cs; rv:1.9.1.8) Gecko/20100202 Firefox/3.5.8",
		useragent.UserAgent{
			useragent.Browser{vars.BrowserFirefox, version.Version{3, 5, 8}},
			useragent.OS{vars.PlatformWindows, vars.OSWindows, version.Version{5, 1, 0}, "XP"},
			vars.DeviceComputer,
		},
	},
	...
	{"Mozilla/5.0 (Windows NT 6.3; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) coc_coc_browser/42.0 CoRom/36.0.1985.144 Chrome/36.0.1985.144 Safari/537.36",
		useragent.UserAgent{
			useragent.Browser{vars.BrowserCocCoc, version.Version{42, 0, 0}},
			useragent.OS{vars.PlatformWindows, vars.OSWindows, version.Version{6, 3, 0}, "8.1"},
			vars.DeviceComputer,
		},
	},
	...
	for _, determined := range testUAVars {
		t.Run("", func(t *testing.T) {
			...
			if ua.Browser.Name != determined.Browser.Name {
				t.Errorf("Browser name: got %v, wanted %v", ua.Browser.Name, determined.Browser.Name)
